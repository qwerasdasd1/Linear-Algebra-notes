# Linear Algebra Lecture Notes / 线性代数讲义

**2025–2026 Linear Algebra Track A / 2025–2026 学年线性代数 A 类**

---

## Overview / 概述

This repository contains the lecture notes for **Linear Algebra Track A**, delivered by **Prof. Yabin Zhang (张雅彬)** at the 2025–2026 academic year. The notes have been compiled and uploaded with the explicit permission of the instructor.

本仓库为 **2025–2026 学年线性代数 A 类课程讲义**，由 **张雅彬** 老师授课。讲义经授课教师明确同意后整理上传。
...
| 02 | Matrices | 矩阵 |
| 03 | Linear Mappings | 线性映射 |
| 04 | Linear Maps and Matrices | 线性映射与矩阵 |
| 05 | Scalar Products and Orthogonality | 标量积与正交性 |
| 06 | Symmetric, Hermitian and Unitary Operators | 对称、厄米与酉算子 |
| 07 | Eigenvectors and Eigenvalues | 特征向量与特征值 |
| 08 | Triangulation and Jordan Form | 三角化与若尔当标准型 |
| 09 | Chinese–English Glossary | 中英术语对照表 |
...
- **Primary Textbook / 主要教材**  
  ...
  本课程以 Serge Lang 所著《Linear Algebra》（第三版）及 Michael Artin 所著《Algebra》（第二版）第 1、3–7 章为主要教材。
...
- **Exam Scope Reference (Credit Exemption) / 免修考试范围参考**  
  If you have previously self-studied linear algebra and intend to sit for a credit exemption exam, these notes can help you gauge the breadth and depth of the course coverage. However, please note that the exam syllabus may vary slightly from year to year.  
  若您已自学过线性代数并希望参加免修考试，本讲义可帮助您了解课程的覆盖范围与深度。但请注意，每年考纲可能略有变动。

---

## Who Should NOT Use These Notes / 不适用人群

- **First-Time Self-Learners / 首次自学线性代数者**  
  These notes were not designed as a standalone textbook. They assume the presence of an instructor and are intended to complement, rather than replace, classroom instruction. Readers encountering linear algebra for the first time are strongly advised to use a comprehensive textbook alongside these materials.  
  本讲义并非为独立学习而设计。讲义假定读者有授课教师指导，旨在补充而非替代课堂教学。强烈建议首次接触线性代数的读者在参考本讲义的同时，系统使用一本完整的教材。
